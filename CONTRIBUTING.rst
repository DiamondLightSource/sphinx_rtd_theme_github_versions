...
.. _dls_controls repository: https://github.com/dls-controls/sphinx_rtd_theme_github_versions/issues
...
To get the source source code and run the unit tests, run::
    ...
    $ git clone git://github.com/dls-controls/sphinx_rtd_theme_github_versions.git
    $ cd sphinx_rtd_theme_github_versions
    $ pipenv install --dev
    $ pipenv run tests
